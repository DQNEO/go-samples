...
mkdir -p $WORK/b006/
mkdir -p $WORK/b005/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b012/importcfg << 'EOF' # internal
# import config
EOF
mkdir -p $WORK/b014/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b006/importcfg << 'EOF' # internal
# import config
EOF
cd /Users/DQNEO/src/github.com/DQNEO/go-samples/birudo
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/compile -o $WORK/b006/_pkg_.a -trimpath "$WORK/b006=>" -p internal/unsafeheader -std -complete -buildid P7qFpguryEe_9bufASvc/P7qFpguryEe_9bufASvc -goversion go1.20.4 -c=4 -nolocalimports -importcfg $WORK/b006/importcfg -pack /usr/local/opt/go/libexec/src/internal/unsafeheader/unsafeheader.go
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/compile -o $WORK/b012/_pkg_.a -trimpath "$WORK/b012=>" -p internal/coverage/rtcov -std -+ -complete -buildid Gk43QGhY-y2T4KaecSdc/Gk43QGhY-y2T4KaecSdc -goversion go1.20.4 -c=4 -nolocalimports -importcfg $WORK/b012/importcfg -pack /usr/local/opt/go/libexec/src/internal/coverage/rtcov/rtcov.go
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b005/importcfg << 'EOF' # internal
# import config
EOF
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b014/importcfg << 'EOF' # internal
# import config
EOF
...
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/compile -o $WORK/b014/_pkg_.a -trimpath "$WORK/b014=>" -p internal/goos -std -+ -complete -buildid yhVHvx5gAuhGe0etJIbA/yhVHvx5gAuhGe0etJIbA -goversion go1.20.4 -c=4 -nolocalimports -importcfg $WORK/b014/importcfg -pack /usr/local/opt/go/libexec/src/internal/goos/goos.go /usr/local/opt/go/libexec/src/internal/goos/unix.go /usr/local/opt/go/libexec/src/internal/goos/zgoos_linux.go
mkdir -p $WORK/b013/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b013/importcfg << 'EOF' # internal
# import config
EOF
...
mkdir -p $WORK/b018/
mkdir -p $WORK/b011/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b018/go_asm.h << 'EOF' # internal
EOF
mkdir -p $WORK/b015/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b011/go_asm.h << 'EOF' # internal
EOF
...
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b015/go_asm.h << 'EOF' # internal
EOF
...
cp $WORK/b013/_pkg_.a /Users/DQNEO/Library/Caches/go-build/8d/8de78bf1ef63a81cea0842fb8c763a9242c3cb58755f22415c152ba39d813fbf-d # internal
cp $WORK/b006/_pkg_.a /Users/DQNEO/Library/Caches/go-build/c5/c5b46fe40f7e8de2493764975e120119586accdba6937c78b1d5361bf99bc5b9-d # internal
cp $WORK/b014/_pkg_.a /Users/DQNEO/Library/Caches/go-build/fc/fc2639e7d82ded59f6db84cb817dd44e79b4ce07bf385d940b6a585ea2251d8d-d # internal
mkdir -p $WORK/b021/
cp $WORK/b005/_pkg_.a /Users/DQNEO/Library/Caches/go-build/46/466361bf073f0514935abe900921ffaa557283dbec238ae7b237bf94e134e05e-d # internal
mkdir -p $WORK/b025/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b021/importcfg << 'EOF' # internal
# import config
EOF
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b025/importcfg << 'EOF' # internal
# import config
EOF
mkdir -p $WORK/b023/
cd /Users/DQNEO/src/github.com/DQNEO/go-samples/birudo
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/compile -o $WORK/b025/_pkg_.a -trimpath "$WORK/b025=>" -p unicode/utf8 -std -complete -buildid cSCUZ94vs3WynnuPq7bO/cSCUZ94vs3WynnuPq7bO -goversion go1.20.4 -c=4 -nolocalimports -importcfg $WORK/b025/importcfg -pack /usr/local/opt/go/libexec/src/unicode/utf8/utf8.go
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/compile -o $WORK/b021/_pkg_.a -trimpath "$WORK/b021=>" -p internal/itoa -std -complete -buildid KywV8ckBASs47DioyK2u/KywV8ckBASs47DioyK2u -goversion go1.20.4 -c=4 -nolocalimports -importcfg $WORK/b021/importcfg -pack /usr/local/opt/go/libexec/src/internal/itoa/itoa.go
mkdir -p $WORK/b009/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b023/importcfg << 'EOF' # internal
# import config
EOF
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/compile -o $WORK/b023/_pkg_.a -trimpath "$WORK/b023=>" -p math/bits -std -complete -buildid dCrtqElNlXZukOS2aC7Q/dCrtqElNlXZukOS2aC7Q -goversion go1.20.4 -c=4 -nolocalimports -importcfg $WORK/b023/importcfg -pack /usr/local/opt/go/libexec/src/math/bits/bits.go /usr/local/opt/go/libexec/src/math/bits/bits_errors.go /usr/local/opt/go/libexec/src/math/bits/bits_tables.go
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b009/go_asm.h << 'EOF' # internal
EOF
...
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b011/importcfg << 'EOF' # internal
# import config
EOF
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b018/importcfg << 'EOF' # internal
# import config
EOF
cd /Users/DQNEO/src/github.com/DQNEO/go-samples/birudo
...
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/compile -o $WORK/b018/_pkg_.a -trimpath "$WORK/b018=>" -p runtime/internal/syscall -std -+ -buildid gZLMb57b8-GCtAQAQvdR/gZLMb57b8-GCtAQAQvdR -goversion go1.20.4 -symabis $WORK/b018/symabis -c=4 -nolocalimports -importcfg $WORK/b018/importcfg -pack -asmhdr $WORK/b018/go_asm.h /usr/local/opt/go/libexec/src/runtime/internal/syscall/defs_linux.go /usr/local/opt/go/libexec/src/runtime/internal/syscall/defs_linux_amd64.go /usr/local/opt/go/libexec/src/runtime/internal/syscall/syscall_linux.go
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b015/importcfg << 'EOF' # internal
# import config
EOF
...
cp $WORK/b012/_pkg_.a /Users/DQNEO/Library/Caches/go-build/92/926df4eb753eaf2114a466757f34e7afdfba1cf6ec04f1f2f34c85063d90e024-d # internal
mkdir -p $WORK/b016/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b009/importcfg << 'EOF' # internal
# import config
...
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b016/importcfg << 'EOF' # internal
# import config
packagefile internal/goarch=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b005/_pkg_.a
EOF
...
cp $WORK/b021/_pkg_.a /Users/DQNEO/Library/Caches/go-build/bf/bf12a0a0c4af776c027cff856238e7151c065ea070c1d8648374631c254efca2-d # internal
cd /usr/local/opt/go/libexec/src/runtime/internal/syscall
...
mkdir -p $WORK/b017/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b017/importcfg << 'EOF' # internal
# import config
packagefile internal/goarch=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b005/_pkg_.a
...
cp $WORK/b025/_pkg_.a /Users/DQNEO/Library/Caches/go-build/3f/3f60081ee412ab78743d2744ee4e8db7b1a927b3480e8a0d74f175a6da78f2b4-d # internal
cp $WORK/b016/_pkg_.a /Users/DQNEO/Library/Caches/go-build/9f/9fdba1d4b52db1d9a6b1ef33709218afb9736e725ac2ed5b2d67732092133118-d # internal
cd /usr/local/opt/go/libexec/src/internal/abi
...
mkdir -p $WORK/b027/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b027/importcfg << 'EOF' # internal
# import config
EOF
cd /Users/DQNEO/src/github.com/DQNEO/go-samples/birudo
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/compile -o $WORK/b027/_pkg_.a -trimpath "$WORK/b027=>" -p internal/race -std -complete -buildid 6k_7JN4Ro6ano3CJO236/6k_7JN4Ro6ano3CJO236 -goversion go1.20.4 -c=4 -nolocalimports -importcfg $WORK/b027/importcfg -pack /usr/local/opt/go/libexec/src/internal/race/doc.go /usr/local/opt/go/libexec/src/internal/race/norace.go
mkdir -p $WORK/b028/
cp $WORK/b023/_pkg_.a /Users/DQNEO/Library/Caches/go-build/8a/8a8af225f53e3267a0e84e9236afd493febe04b00f6a1ebca9a385425ec5eb8b-d # internal
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b028/go_asm.h << 'EOF' # internal
EOF
...
mkdir -p $WORK/b029/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b029/importcfg << 'EOF' # internal
# import config
EOF
cd /usr/local/opt/go/libexec/src/runtime/internal/atomic
...
cd /Users/DQNEO/src/github.com/DQNEO/go-samples/birudo
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/compile -o $WORK/b029/_pkg_.a -trimpath "$WORK/b029=>" -p unicode -std -complete -buildid H5EVtAclvmQgmtO5OIl1/H5EVtAclvmQgmtO5OIl1 -goversion go1.20.4 -c=4 -nolocalimports -importcfg $WORK/b029/importcfg -pack /usr/local/opt/go/libexec/src/unicode/casetables.go /usr/local/opt/go/libexec/src/unicode/digit.go /usr/local/opt/go/libexec/src/unicode/graphic.go /usr/local/opt/go/libexec/src/unicode/letter.go /usr/local/opt/go/libexec/src/unicode/tables.go
cd /usr/local/opt/go/libexec/src/internal/abi
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/pack r $WORK/b009/_pkg_.a $WORK/b009/abi_test.o # internal
cp $WORK/b018/_pkg_.a /Users/DQNEO/Library/Caches/go-build/1d/1d8e21f62bbc5b5ae39b82f62d2103f987588ed752533b349b007897e395d080-d # internal
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/buildid -w $WORK/b009/_pkg_.a # internal
cp $WORK/b009/_pkg_.a /Users/DQNEO/Library/Caches/go-build/97/97e46b4de6600d66a48c41890d9b418b13b20b22bb9116831e53bb277d3cc219-d # internal
cd /usr/local/opt/go/libexec/src/internal/cpu
...
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b028/importcfg << 'EOF' # internal
# import config
EOF
...
cp $WORK/b027/_pkg_.a /Users/DQNEO/Library/Caches/go-build/8d/8d8748d628c00b0e17ec37c3b489e3f71aa648f54ebd42850107185a25c9c5d0-d # internal
cp $WORK/b017/_pkg_.a /Users/DQNEO/Library/Caches/go-build/89/894fd9e5b3ec676bfc6db7792d9a73a660cab83b1469ee8b0ec1c7ab471453f3-d # internal
cd /usr/local/opt/go/libexec/src/runtime/internal/atomic
...
cp $WORK/b015/_pkg_.a /Users/DQNEO/Library/Caches/go-build/9b/9b27352913aac753062d263539a28267204689b4f2b07b08874edc157621a704-d # internal
cp $WORK/b011/_pkg_.a /Users/DQNEO/Library/Caches/go-build/06/0621a8c86a0f8a0475a63e05793305315e8701bc4b5d35227f39367f20a85bf7-d # internal
mkdir -p $WORK/b010/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b010/go_asm.h << 'EOF' # internal
EOF
...
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b022/importcfg << 'EOF' # internal
# import config
packagefile internal/cpu=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b011/_pkg_.a
...
cp $WORK/b028/_pkg_.a /Users/DQNEO/Library/Caches/go-build/60/607d046547a61f90e414bc462b44559534605a2b3331d30e80987de78eccec02-d # internal
...
cp $WORK/b010/_pkg_.a /Users/DQNEO/Library/Caches/go-build/3d/3d8c80401513467afb4c0ae8bfb06d098f84d53f83c67e867a73d5a9bd52c621-d # internal
mkdir -p $WORK/b008/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b008/go_asm.h << 'EOF' # internal
EOF
...
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b008/importcfg << 'EOF' # internal
# import config
...
cp $WORK/b029/_pkg_.a /Users/DQNEO/Library/Caches/go-build/30/308aea17052e8d51adf8f3285ffddca41cb8097847ac43ecee40818df8954816-d # internal
...
cp $WORK/b022/_pkg_.a /Users/DQNEO/Library/Caches/go-build/90/90e33f0d8f79c7585c1559728930cf6936e8721a38d6c2b25ab179c8cce393d3-d # internal
...
cp $WORK/b008/_pkg_.a /Users/DQNEO/Library/Caches/go-build/f5/f5eae97d918371c7c83fe2a88e9dbb2fec09960c36aeb1d26b1c2f09d89305f9-d # internal
mkdir -p $WORK/b004/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b004/go_asm.h << 'EOF' # internal
EOF
...
mkdir -p $WORK/b026/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b026/importcfg << 'EOF' # internal
# import config
...
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b004/importcfg << 'EOF' # internal
# import config
packagefile internal/goarch=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b005/_pkg_.a
...
cp $WORK/b026/_pkg_.a /Users/DQNEO/Library/Caches/go-build/8c/8ca5cd7b10f028bde0add0570182855542c74dd7b0f3f185d05d55cfb2761225-d # internal
mkdir -p $WORK/b040/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b040/importcfg << 'EOF' # internal
# import config
...
cp $WORK/b040/_pkg_.a /Users/DQNEO/Library/Caches/go-build/cd/cde97acef886e8f87e5610349ed4489b23a91ea2a610ba3fc6155f73d540d8a1-d # internal
cd /usr/local/opt/go/libexec/src/internal/reflectlite
...
cp $WORK/b004/_pkg_.a /Users/DQNEO/Library/Caches/go-build/68/68e93efe874f570ec44808ba740ec9e7f85ae99517fc1aa4d7d47a25f1ba0dd5-d # internal
mkdir -p $WORK/b003/
mkdir -p $WORK/b030/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b003/importcfg << 'EOF' # internal
# import config
...
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b030/importcfg << 'EOF' # internal
# import config
packagefile internal/reflectlite=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b004/_pkg_.a
packagefile math/bits=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b023/_pkg_.a
EOF
...
cp $WORK/b003/_pkg_.a /Users/DQNEO/Library/Caches/go-build/c3/c3ca51b3dbf02d375ed334068291399ab9045e70f116b083e81befc8b32073f9-d # internal
mkdir -p $WORK/b038/
mkdir -p $WORK/b036/
mkdir -p $WORK/b042/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b038/importcfg << 'EOF' # internal
# import config
packagefile errors=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b003/_pkg_.a
packagefile runtime=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b008/_pkg_.a
EOF
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b036/importcfg << 'EOF' # internal
# import config
packagefile errors=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b003/_pkg_.a
EOF
mkdir -p $WORK/b031/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b042/importcfg << 'EOF' # internal
# import config
packagefile errors=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b003/_pkg_.a
packagefile internal/bytealg=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b010/_pkg_.a
...
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b031/importcfg << 'EOF' # internal
# import config
packagefile errors=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b003/_pkg_.a
packagefile sync=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b026/_pkg_.a
EOF
...
mkdir -p $WORK/b024/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b024/importcfg << 'EOF' # internal
# import config
packagefile errors=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b003/_pkg_.a
packagefile internal/bytealg=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b010/_pkg_.a
...
cp $WORK/b038/_pkg_.a /Users/DQNEO/Library/Caches/go-build/7f/7f19737cdc4b7a80fe6c79a5773771840937e0649edced18bda637085f3eb5a7-d # internal
cp $WORK/b036/_pkg_.a /Users/DQNEO/Library/Caches/go-build/6b/6bfc832c097aa830784db2380ca2fbeb0c5bbe680d0ce64ceda4afd925e21407-d # internal
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/buildid -w $WORK/b042/_pkg_.a # internal
cp $WORK/b042/_pkg_.a /Users/DQNEO/Library/Caches/go-build/e3/e3566d6415cf10d62a5e496f409fab9922ec7c27417ea8ce5fe5a5a331f9b7f5-d # internal
...
cp $WORK/b030/_pkg_.a /Users/DQNEO/Library/Caches/go-build/15/15c97b460afc045139634ffdd726154b4fce1651774ecd3a8a04434096da3516-d # internal
mkdir -p $WORK/b035/
cp $WORK/b031/_pkg_.a /Users/DQNEO/Library/Caches/go-build/3f/3f47dbb23d8a725a8add0ccee53d305b53d47438adf59f282afb4e58c957e946-d # internal
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b035/go_asm.h << 'EOF' # internal
EOF
...
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b035/importcfg << 'EOF' # internal
# import config
packagefile errors=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b003/_pkg_.a
packagefile internal/bytealg=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b010/_pkg_.a
...
cp $WORK/b024/_pkg_.a /Users/DQNEO/Library/Caches/go-build/1a/1ad0a4bf26d6a401443abecef2c0d58a39aa53cee9a04b799ed3b380005d7b6a-d # internal
mkdir -p $WORK/b020/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b020/go_asm.h << 'EOF' # internal
EOF
...
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b020/importcfg << 'EOF' # internal
# import config
packagefile errors=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b003/_pkg_.a
packagefile internal/abi=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b009/_pkg_.a
packagefile internal/bytealg=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b010/_pkg_.a
...
cp $WORK/b035/_pkg_.a /Users/DQNEO/Library/Caches/go-build/90/90c34d05dac34b8a71d3fe8c56629372bbf8c526cb99cd62209ee723971848f7-d # internal
mkdir -p $WORK/b039/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b039/importcfg << 'EOF' # internal
# import config
...
mkdir -p $WORK/b034/
mkdir -p $WORK/b037/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b034/importcfg << 'EOF' # internal
# import config
packagefile sync/atomic=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b028/_pkg_.a
packagefile syscall=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b035/_pkg_.a
EOF
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b037/importcfg << 'EOF' # internal
# import config
packagefile errors=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b003/_pkg_.a
packagefile runtime=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b008/_pkg_.a
packagefile sync=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b026/_pkg_.a
...
cp $WORK/b039/_pkg_.a /Users/DQNEO/Library/Caches/go-build/5a/5a5ad223fd7e129835d0f9a6c6ccecc70c2b50f40b78a6d4d20b06fafd51821b-d # internal
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/buildid -w $WORK/b034/_pkg_.a # internal
cp $WORK/b034/_pkg_.a /Users/DQNEO/Library/Caches/go-build/42/426f444477d471f5cd570f0597420b970c802a8fbf1ca0ad38ac3b30f8bc3f0a-d # internal
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/buildid -w $WORK/b037/_pkg_.a # internal
cp $WORK/b037/_pkg_.a /Users/DQNEO/Library/Caches/go-build/2d/2d930289955ec68431cef7e8d9bb7b5b2d6dccd93e45f68f63868cf7045146af-d # internal
mkdir -p $WORK/b041/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b041/importcfg << 'EOF' # internal
# import config
packagefile errors=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b003/_pkg_.a
packagefile internal/oserror=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b036/_pkg_.a
...
mkdir -p $WORK/b033/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b033/importcfg << 'EOF' # internal
# import config
packagefile errors=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b003/_pkg_.a
...
cp $WORK/b020/_pkg_.a /Users/DQNEO/Library/Caches/go-build/d5/d5fd69d99da4bee5f1ec02b332f5f903af8e9e36df61950ce58553ec3f55b3a3-d # internal
mkdir -p $WORK/b019/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b019/importcfg << 'EOF' # internal
# import config
...
cp $WORK/b041/_pkg_.a /Users/DQNEO/Library/Caches/go-build/2c/2c2609c66a19a399f3dab8b33bd4da54655aefd1e62414acfe3fe7ffda6e7770-d # internal
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/buildid -w $WORK/b019/_pkg_.a # internal
cp $WORK/b019/_pkg_.a /Users/DQNEO/Library/Caches/go-build/60/60db98208e085d1cb81f8849168369dd6dffaa75a2a8817537ff9840e544def8-d # internal
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/buildid -w $WORK/b033/_pkg_.a # internal
cp $WORK/b033/_pkg_.a /Users/DQNEO/Library/Caches/go-build/8a/8a23e35e436231c957d53722575f693b9876e4444db8b34bddfa4b3af0d1a960-d # internal
mkdir -p $WORK/b032/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b032/importcfg << 'EOF' # internal
# import config
packagefile errors=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b003/_pkg_.a
packagefile internal/itoa=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b021/_pkg_.a
...
cp $WORK/b032/_pkg_.a /Users/DQNEO/Library/Caches/go-build/9f/9f4f9105c37b2865b130bc5f783edf18bd1066b6d71eee53c8f53f2da3e87710-d # internal
mkdir -p $WORK/b002/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b002/importcfg << 'EOF' # internal
# import config
packagefile errors=/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b003/_pkg_.a
...
cp $WORK/b002/_pkg_.a /Users/DQNEO/Library/Caches/go-build/cf/cff345f70671e508776e8b231b79e372c4676ffe417a1a3806c5caf95e9bd7cf-d # internal
mkdir -p $WORK/b001/
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b001/importcfg << 'EOF' # internal
# import config
...
cat >/var/folders/bq/2mhmkrcn59dd9t7pq5_6hbw80000gp/T/go-build2769554778/b001/importcfg.link << 'EOF' # internal
...
cd .
/usr/local/opt/go/libexec/pkg/tool/darwin_amd64/link -o $WORK/b001/exe/a.out -importcfg $WORK/b001/importcfg.link -buildmode=exe -buildid=yekYyg_HZMgX517VPpiO/aHxht5d7JGm1qJULUhhT/ct0PU8-vieH10gtMxGeC/yekYyg_HZMgX517VPpiO -extld=cc $WORK/b001/_pkg_.a
