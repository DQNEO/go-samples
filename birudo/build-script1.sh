...
build_pkg_asm runtime/internal/syscall 1 0 defs_linux.go defs_linux_amd64.go syscall_linux.go ./asm_linux_amd64.s
build_pkg_asm internal/cpu 1 0 cpu.go cpu_x86.go ./cpu.s ./cpu_x86.s
build_pkg_asm runtime/internal/atomic 1 0 atomic_amd64.go doc.go stubs.go types.go types_64bit.go unaligned.go ./atomic_amd64.s
